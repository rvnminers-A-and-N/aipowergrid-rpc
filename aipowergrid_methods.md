# Aipowergrid remote procedure calls/methods
[Home](README.md)
&nbsp;<br> &nbsp;<br/>
## abandontransaction
...
Examples:
> aipg-cli getrawtransaction "mytxid"
> aipg-cli getrawtransaction "mytxid" true
...
> aipg-cli getreceivedbyaccount ""

Amount received at the tabby account including unconfirmed amounts with zero confirmations
> aipg-cli getreceivedbyaccount "tabby" 0

The amount with at least 6 confirmations
> aipg-cli getreceivedbyaccount "tabby" 6
...
> aipg-cli getreceivedbyaddress "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX"

The amount including unconfirmed transactions, zero confirmations
> aipg-cli getreceivedbyaddress "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" 0

The amount with at least 6 confirmations
> aipg-cli getreceivedbyaddress "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" 6
...
Examples:
> aipg-cli getsnapshotrequest "TRONCO" 12345
...
Examples:
> aipg-cli getspentinfo '{"txid": "0437cd7f8525ceed2324359c2d0ba26006d92d856a9c20fa0241106ee5a597c9", "index": 0}'
...
Examples:
> aipg-cli gettransaction "1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d"
> aipg-cli gettransaction "1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d" true
...
> aipg-cli listunspent 

View the details
> aipg-cli gettxout "txid" 1
...
Examples:
> aipg-cli getverifierstring "restricted_name"
...
> aipg-cli importaddress "myscript"

Import using a label without rescan
> aipg-cli importaddress "myscript" "testing" false
...
Examples:
> aipg-cli importmulti '[{ "scriptPubKey": { "address": "<my address>" }, "timestamp":1455191478 }, { "scriptPubKey": { "address": "<my 2nd address>" }, "label": "example 2", "timestamp": 1455191480 }]'
> aipg-cli importmulti '[{ "scriptPubKey": { "address": "<my address>" }, "timestamp":1455191478 }]' '{ "rescan": false}'
...
> aipg-cli importprivkey "mykey" "testing" false

Import using default blank label and without rescan
> aipg-cli importprivkey "mykey" "" false
...
> aipg-cli importpubkey "mypubkey"

Import using a label without rescan
> aipg-cli importpubkey "mypubkey" "testing" false
...
Examples:
> aipg-cli issue "ASSET_NAME" 1000
> aipg-cli issue "ASSET_NAME" 1000 "myaddress"
> aipg-cli issue "ASSET_NAME" 1000 "myaddress" "changeaddress" 4
> aipg-cli issue "ASSET_NAME" 1000 "myaddress" "changeaddress" 2 true
> aipg-cli issue "ASSET_NAME" 1000 "myaddress" "changeaddress" 8 false true QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E
> aipg-cli issue "ASSET_NAME/SUB_ASSET" 1000 "myaddress" "changeaddress" 2 true
> aipg-cli issue "ASSET_NAME#uniquetag"
...
Examples:
> aipg-cli issuequalifierasset "#ASSET_NAME" 1000
> aipg-cli issuequalifierasset "ASSET_NAME" 1000 "myaddress"
> aipg-cli issuequalifierasset "#ASSET_NAME" 1000 "myaddress" "changeaddress"
> aipg-cli issuequalifierasset "ASSET_NAME" 1000 "myaddress" "changeaddress"
> aipg-cli issuequalifierasset "#ASSET_NAME" 1000 "myaddress" "changeaddress" true QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E
> aipg-cli issuequalifierasset "ASSET_NAME/SUB_QUALIFIER" 1000 "myaddress" "changeaddress"
> aipg-cli issuequalifierasset "#ASSET_NAME"
...
Examples:
> aipg-cli issuerestrictedasset "$ASSET_NAME" 1000 "#KYC & !#AML" "myaddress"
> aipg-cli issuerestrictedasset "$ASSET_NAME" 1000 "#KYC & !#AML" "myaddress"
> aipg-cli issuerestrictedasset "$ASSET_NAME" 1000 "#KYC & !#AML" "myaddress" "changeaddress" 5
> aipg-cli issuerestrictedasset "$ASSET_NAME" 1000 "#KYC & !#AML" "myaddress" "changeaddress" 8 true
> aipg-cli issuerestrictedasset "$ASSET_NAME" 1000 "#KYC & !#AML" "myaddress" "changeaddress" 0 false true QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E
...
Examples:
> aipg-cli issueunique "MY_ASSET" '["primo","secundo"]'
> aipg-cli issueunique "MY_ASSET" '["primo","secundo"]' '["first_hash","second_hash"]'
...
Examples:
> aipg-cli isvalidverifierstring "verifier_string"
...
> aipg-cli listaccounts 

List account balances including zero confirmation transactions
> aipg-cli listaccounts 0

List account balances for 6 or more confirmations
> aipg-cli listaccounts 6
...
Examples:
> aipg-cli listaddressesbyasset "ASSET_NAME" false 2 0
> aipg-cli listaddressesbyasset "ASSET_NAME" true
> aipg-cli listaddressesbyasset "ASSET_NAME"
...
Examples:
> aipg-cli listaddressesfortag "#TAG"
...
Examples:
> aipg-cli listaddressrestrictions "address"
...
Examples:
> aipg-cli listassetbalancesbyaddress "myaddress" false 2 0
> aipg-cli listassetbalancesbyaddress "myaddress" true
> aipg-cli listassetbalancesbyaddress "myaddress"
...
> aipg-cli listassets ASSET
> aipg-cli listassets "ASSET*" true 10 20
...
Examples:
> aipg-cli listglobalrestrictions 
...
> aipg-cli lockunspent false "[{\"txid\":\"a08e6907dbbd3d809776dbfc5d82e371b764ed838b5655e72f463568df1aadf0\",\"vout\":1}]"

List the locked transactions
> aipg-cli listlockunspent 

Unlock the transaction again
> aipg-cli lockunspent true "[{\"txid\":\"a08e6907dbbd3d809776dbfc5d82e371b764ed838b5655e72f463568df1aadf0\",\"vout\":1}]"
...
> aipg-cli listmyassets ASSET
> aipg-cli listmyassets "ASSET*" true 10 20
> aipg-cli listmyassets "ASSET*" true 10 20 1
...
Examples:
> aipg-cli listreceivedbyaccount 
> aipg-cli listreceivedbyaccount 6 true
...
Examples:
> aipg-cli listreceivedbyaddress 
> aipg-cli listreceivedbyaddress 6 true
...
Examples:
> aipg-cli listsinceblock 
> aipg-cli listsinceblock "000000000000000bacf66f7497b7dc45ef753ee9a7d38571037cdb1a57f663ad" 6
...
Examples:
> aipg-cli listtagsforaddress "address"
...
> aipg-cli listtransactions 

List transactions 100 to 120
> aipg-cli listtransactions "*" 20 100
...
Examples
> aipg-cli listunspent 
> aipg-cli listunspent 6 9999999 "[\"1PGFqEzfmQch1gKD3ra4k18PNj3tTUUSqg\",\"1LtvqCaApEdUGFkpKMM4MstjcaL4dKg8SP\"]"
...
> aipg-cli listunspent 6 9999999 '[]' true '{ "minimumAmount": 0.005 }'
...
Examples:
> aipg-cli pprpcsb "header_hash" "mix_hash" 100000
...
Examples:
> aipg-cli preciousblock "blockhash"
...
Examples:
> aipg-cli prioritisetransaction "txid" 0.0 10000
...
Examples:
> aipg-cli purgesnapshot "ASSET_NAME" 28546
...
Examples:
> aipg-cli reissue "ASSET_NAME" 20 "address"
...
Examples:
> aipg-cli reissuerestrictedasset "$ASSET_NAME" 1000  "myaddress" true "KYC & !AML"
> aipg-cli reissuerestrictedasset "$ASSET_NAME" 1000  "myaddress" true "KYC & !AML" 
> aipg-cli reissuerestrictedasset "$ASSET_NAME" 1000  "myaddress" true "KYC & !AML" "changeaddress"
> aipg-cli reissuerestrictedasset "$ASSET_NAME" 1000  "myaddress" true "KYC & !AML" "changeaddress" -1 true
> aipg-cli reissuerestrictedasset "$ASSET_NAME" 1000  "myaddress" false "" "changeaddress" -1 false QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E
...
Examples:
> aipg-cli removeprunedfunds "a8d0c0184dde994a09ec054286f1ce581bebf46446a512166eae7628734ea0a5"
...
Examples:
> aipg-cli removetagfromaddress "#TAG" "to_address"
...
> aipg-cli removetagfromaddress "#TAG" "to_address" "change_address"
...
Examples:
> aipg-cli requestsnapshot "TRONCO" 12345
...
Examples:
> aipg-cli rescanblockchain 100000 120000
...
> aipg-cli sendfrom "" "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.01

Send 0.01 from the tabby account to the given address, funds must have at least 6 confirmations
> aipg-cli sendfrom "tabby" "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.01 6 "donation" "seans outpost"
...
Examples:
> aipg-cli sendfromaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1
> aipg-cli sendfromaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1 "donation" "seans outpost"
> aipg-cli sendfromaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1 "" "" true
...
2. "amounts"             (string, required) A json object with addresses and amounts
    {
      "address":amount   (numeric or string) The aipg address is the key, the numeric amount (can be string) in RVN is the value
      ,...
    }
...
> aipg-cli sendmany "" "{\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\":0.01,\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\":0.02}"

Send two amounts to two different addresses setting the confirmation and comment:
> aipg-cli sendmany "" "{\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\":0.01,\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\":0.02}" 6 "testing"

Send two amounts to two different addresses, subtract fee from amount:
> aipg-cli sendmany "" "{\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\":0.01,\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\":0.02}" 1 "" "[\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\",\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\"]"
...
Examples:
> aipg-cli sendmessage "ASSET_NAME!" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 15863654
> aipg-cli sendmessage "ASSET_NAME!" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 15863654
...
> aipg-cli createrawtransaction "[{\"txid\" : \"mytxid\",\"vout\":0}]" "{\"myaddress\":0.01}"
Sign the transaction, and get back the hex
> aipg-cli signrawtransaction "myhex"

Send the transaction (signed hex)
> aipg-cli sendrawtransaction "signedhex"
...
Examples:
> aipg-cli sendtoaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1
> aipg-cli sendtoaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1 "donation" "seans outpost"
> aipg-cli sendtoaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1 "" "" true
...
Examples:
> aipg-cli setaccount "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" "tabby"
...
Examples:
> aipg-cli setban "192.168.0.6" "add" 86400
> aipg-cli setban "192.168.0.0/24" "add"
...
> aipg-cli setgenerate true 1

Check the setting
> aipg-cli getgenerate 

Turn off generation
> aipg-cli setgenerate false
...
> aipg-cli walletpassphrase "mypassphrase" 30

Create the signature
> aipg-cli signmessage "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" "my message"

Verify the signature
> aipg-cli verifymessage "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" "signature" "my message"
...
Create the signature
> aipg-cli signmessagewithprivkey "privkey" "my message"
...
Examples:
> aipg-cli subscribetochannel "ASSET_NAME!"
...
> aipg-cli testmempoolaccept "signedhex"
...
Examples:
> aipg-cli transfer "ASSET_NAME" 20 "address" "" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 15863654
> aipg-cli transfer "ASSET_NAME" 20 "address" "" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 15863654
...
Examples:
> aipg-cli transferfromaddress "ASSET_NAME" "fromaddress" 20 "address" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E", 156545652
...
Examples:
> aipg-cli transferfromaddresses "ASSET_NAME" '["fromaddress1", "fromaddress2"]' 20 "to_address" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 154652365
...
Examples:
> aipg-cli transferqualifier "#QUALIFIER" 20 "to_address" "" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 15863654
> aipg-cli transferqualifier "#QUALIFIER" 20 "to_address" "change_address" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 15863654
...
Examples:
> aipg-cli unfreezeaddress "$RESTRICTED_ASSET" "address"
...
> aipg-cli unfreezeaddress "$RESTRICTED_ASSET" "address" "change_address"
...
Examples:
> aipg-cli unfreezerestrictedasset "$RESTRICTED_ASSET"
...
> aipg-cli unfreezerestrictedasset "$RESTRICTED_ASSET" "change_address"
...
Examples:
> aipg-cli unsubscribefromchannel "ASSET_NAME!"
...
Examples:
> aipg-cli validateaddress "1PSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc"
...
Examples:
> aipg-cli viewallmessagechannels 
...
Examples:
> aipg-cli viewmyrestrictedaddresses 
...
Examples:
> aipg-cli viewmytaggedaddresses 
